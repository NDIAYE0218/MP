...
var Marche_inf= require('./controleur/MarcheInformatique')
app.use(fileupload());
...
app.use(function (req, res, next) {
 //res.header("Access-Control-Allow-Origin", "http://amp.ville-clichy.fr:4200");
  ...
  res.setHeader('Access-Control-Allow-Credentials', true);//lancement du process de notification informatique
  next();
});
var j = schedule.scheduleJob('30 45 14 * * *',notification.Scrutteur_Notification);//lancement du process de notification
var z = schedule.scheduleJob('20 01 16 * * *',Marche_inf.AlertMarket);
